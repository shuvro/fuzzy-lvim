...
require("lvim.user.neovim").config()
...
if user and user == "shuvro" then
  ...
  require("lvim.user.custom_user").config()
end
...
-- =========================================
require("lvim.user.builtin").config()

-- StatusLine
-- =========================================
if lvim.builtin.fancy_statusline.active then
  require("lvim.user.lualine").config()
end

-- Debugging
-- =========================================
if lvim.builtin.dap.active then
  require("lvim.user.dap").config()
end
...
require("lvim.user.null_ls").config()

-- Additional Plugins
-- =========================================
require("lvim.user.plugins").config()

-- Autocommands
-- =========================================
require("lvim.user.autocommands").config()

-- Additional Keybindings
-- =========================================
require("lvim.user.keybindings").config()
