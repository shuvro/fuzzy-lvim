...
M.config = function()
  ...
  if lvim.builtin.bufferline.active then
    require("lvim.user.bufferline").config()
  end
  ...
  local alpha_opts = require("lvim.user.dashboard").config()
  ...
  -- IndentBlankline
  -- =========================================
  require("lvim.user.indent_blankline").config()
  ...
  lvim.lsp.buffer_mappings.normal_mode["gI"] = {
    "<cmd>lua require('lvim.user.telescope').lsp_implementations()<CR>",
    "Goto Implementation",
  }
  ...
  lvim.lsp.buffer_mappings.normal_mode["gp"] = {
    function()
      require("lvim.user.peek").Peek "definition"
    end,
    "Peek definition",
  }
  lvim.lsp.buffer_mappings.normal_mode["K"] = {
    "<cmd>lua require('lvim.user.builtin').show_documentation()<CR>",
    "Show Documentation",
  }
  ...
  local user_telescope = require "lvim.user.telescope"
  ...
  if not lvim.use_icons and lvim.builtin.custom_web_devicons then
    require("lvim.user.dev_icons").use_my_icons()
  end
end
