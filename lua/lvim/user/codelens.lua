...
if vim.tbl_isempty(vim.fn.sign_getdefined(SIGN_NAME)) then
  vim.fn.sign_define(SIGN_NAME, { text = require("lvim.user.lsp_kind").icons.code_action, texthl = "MoreMsg" })
end
...
M.update_sign = function(priority, old_line, new_line, bufnr, text)
  ...
  local icon = require("lvim.user.lsp_kind").icons.code_action
  if text == "code_lens_action" then
    icon = require("lvim.user.lsp_kind").icons.code_lens_action
  end
