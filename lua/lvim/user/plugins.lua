  ...
  lvim.plugins = {
    {
      ...
      as = "rose-pine",
      config = function()
        require("lvim.user.theme").rose_pine()
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.theme").catppuccin()
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.theme").kanagawa()
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.lsp_signature").config()
      end,
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.todo_comments").config()
      end,
      event = "BufRead",
    },
    {
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.lightspeed").config()
      end,
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.symbols_outline").config()
      end,
      event = "BufReadPost",
    ...
    },
    {
      "folke/twilight.nvim",
      config = function()
        require("lvim.user.twilight").config()
      end,
      event = "BufRead",
    },
    {
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.rust_tools").config()
      end,
      ft = { "rust", "rs" },
    ...
    },
    {
      ...
      event = "BufRead",
      config = function()
        require("lvim.user.spectre").config()
      end,
    },
    {
      "norcalli/nvim-colorizer.lua",
      config = function()
        require("lvim.user.colorizer").config()
      end,
      event = "BufReadPre",
    },
    {
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.presence").config()
      end,
    ...
    { "mfussenegger/nvim-jdtls", ft = "java" },
    {
      ...
      ft = { "org" },
      config = function()
        require("lvim.user.orgmode").setup()
      end,
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.vim_test").config()
      end,
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.ntest").config()
      end,
      requires = {
    ...
    },
    {
      ...
      requires = "nvim-lua/plenary.nvim",
      config = function()
        require("lvim.user.flutter_tools").config()
      end,
      ft = "dart",
    },
    {
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.neoclip").config()
      end,
      opt = true,
      keys = "<leader>y",
    ...
    },
    {
      "github/copilot.vim",
      config = function()
        require("lvim.user.copilot").config()
      end,
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.diffview").config()
      end,
    ...
    },
    {
      ...
      after = { "nvim-cmp" },
      config = function()
        require("lvim.user.tabout").config()
      end,
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.hlslens").config()
      end,
      event = "BufReadPost",
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.sidebar").config()
      end,
      -- event = "BufRead",
    ...
    },
    {
      "j-hui/fidget.nvim",
      config = function()
        require("lvim.user.fidget_spinner").config()
      end,
    },
    {
      "michaelb/sniprun",
    ...
    },
    {
      ...
      setup = function()
        require("lvim.user.vista").config()
      end,
      event = "BufReadPost",
    ...
    },
    {
      ...
      requires = { { "nvim-lua/plenary.nvim" } },
      config = function()
        require("lvim.user.crates").config()
      end,
      disable = not lvim.builtin.rust_programming.active,
    },
    {
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.legendary").config()
      end,
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.dress").config()
      end,
    ...
    },
    {
      "b0o/incline.nvim",
      config = function()
        require("lvim.user.incline").config()
      end,
    ...
    },
    {
      ...
      config = function()
        require("lvim.user.neotree").config()
      end,
    ...
    },
    {
      ...
      event = "VimEnter",
      config = function()
        require("lvim.user.noice").config()
      end,
      requires = {
        "MunifTanjim/nui.nvim",
